let githubUser = 'Bubpachat'
let repo = 'Bubpachat.github.io'
...
async function login() {
    ...
    const response = await fetch('https://script.google.com/macros/s/AKfycbwhqcoZ4rdp612kRuSFiRARImiGb54YlxkM-pn2uOs57s8YEzJDUHNFHGhC1HWwpaJQ6w/exec');
...
async function loadAlbum(username, albumName) {
    const response = await fetch(`https://api.github.com/repos/${githubUser}/${repo}/contents/${admin}/${albumName}`);
